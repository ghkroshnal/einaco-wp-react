<?php // namespace hide_site_title_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "hide_site_title_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class hide_site_title_Bill_Minozzi_Add_Ajax_Url {
...
$hide_site_title_bill_minozzi_add_ajax_url = new hide_site_title_Bill_Minozzi_Add_Ajax_Url();
class hide_site_title_Bill_show_more_plugins
{
    //
    public function __construct()
    {
    ...
    //    add_action("wp_ajax_bill_install_plugin2", "bill_install_plugin2");
        // add_action('wp_ajax_bill_install_plugin2', array('\hide_site_title_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
       ...
       // work add_action('wp_ajax_bill_install_plugin2', '\hide_site_title_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new hide_site_title_Bill_show_more_plugins();
// } // end namespace
class hide_site_title_PluginInstaller {
    public function __construct() {
    ...
    $plugin = $slug;
    $skin = new \hide_site_title_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new hide_site_title_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class hide_site_title_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new hide_site_title_bill_install_QuietSkin();
